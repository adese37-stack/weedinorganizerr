...
`assets/audio/ambient-wedding.wav`
...
## Revisi Khusus Puji & Galang

- Tanggal: 29 Desember 2026.
- Lokasi akad dan resepsi: Puri Begawan, Bogor.
- Musik: `assets/audio/wedding-music.mp3`.
- Foto menggunakan berkas yang diberikan pengguna.
- Fitur Wedding Gift dihapus.
- Ditambahkan peta interaktif, Google Calendar, animasi nama tamu, konfeti, timeline interaktif, dan lightbox.
